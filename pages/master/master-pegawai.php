...
<?php	
	...
	include "dist/koneksi.php";
		...
		if (empty($_POST['nama']) || empty($_POST['jk']) || empty($_POST['jab']) || empty($_POST['tmp_lhr']) || empty($_POST['tgl_lhr']) || empty($_POST['gol_darah']) || empty($_POST['agama']) || empty($_POST['status'])) {
		...
		$insert_user = "INSERT INTO tb_user (id_user, nip, password, hak_akses, aktif) VALUES ('$nip', '$nip', '123', 'Pegawai', 'N')";
