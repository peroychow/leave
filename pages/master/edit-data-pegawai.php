...
<?php
	...
	if ($_POST['edit'] == "edit") {
		...
		$update= mysqli_query ($con, "UPDATE tb_pegawai SET nama='$nama', jk='$jk', jab='$jab',tmp_lhr='$tmp_lhr', tgl_lhr='$tgl_lhr', gol_darah='$gol_darah', agama='$agama', status='$status', telp='$telp', alamat='$alamat' WHERE nip='$nip'");
		if($update){
