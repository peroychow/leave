								...
								<div class="panel-body">
									<form action="home-admin.php?page=master-pegawai" class="form-horizontal" method="POST" enctype="multipart/form-data">
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input type="text" name="nip" class="form-control" placeholder="NIP" maxlength="64">
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Nama</label>
											<div class="col-sm-7">
												<input type="text" name="nama" class="form-control" placeholder="Nama" maxlength="40">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<input type="text" name="jab" class="form-control" placeholder="Jabatan" maxlength="40">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-7">
												<select name="status" class="form-control">
													<option selected value="K0">K0</option>
