...
<?php	
	...
	$cekuser	=mysqli_num_rows (mysqli_query($con, "SELECT id_user FROM tb_user WHERE id_user='$_POST[id_user]'"));
	
		if (empty($_POST['id_user']) || empty($_POST['nip']) || empty($_POST['password']) || empty($_POST['hak_akses'])) {
		...
		$insert = "INSERT INTO tb_user (id_user, nip, password, hak_akses, aktif) VALUES ('$id_user', '$nip', '$password', '$hak_akses', 'Y')";
